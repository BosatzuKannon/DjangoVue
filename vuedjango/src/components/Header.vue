<template>
    <div>
        <b-navbar type="dark" variant="dark" class="mb-3">
            ...
            <b-navbar-nav>
                <!--<b-nav-item href="#"><router-link to="/">List</router-link></b-nav-item>

                <b-nav-item href="#"><router-link to="/detail">Detail</router-link></b-nav-item>-->
                ...
                <b-nav-item-dropdown text="Categories" right>
                    <b-dropdown-item v-for="c in categories" v-bind:key="c.id" :to=" '/type/' + c.id + '/elements'">
                        {{ c.title }}
                    </b-dropdown-item>
                </b-nav-item-dropdown>
